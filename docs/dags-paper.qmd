...
subtitle: Adapting qualitative and quantitative research methods for better inferences about existing arguments and evidence
...
Portions of texts that review prior literature often include a named concept or causal claim followed by a string of citations. This is an assertion that all of those studies mean the same thing when they use this language. If they used different words, it is an assertion that they meant the same thing. This is parallel to the "unit homogeneity" assumption in quantitative research [@KKV, p. 91] and process tracing [@Beach2013, p. XX]---that these prior studies are all cases of the same thing. 
...
edges |> filter( cites == "Ziblatt 2009")  |>
  netlit_plot()
```
